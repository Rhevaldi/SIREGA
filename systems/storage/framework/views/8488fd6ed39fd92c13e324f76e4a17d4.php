<?php $__env->startSection('title', 'Tambah Media Warga'); ?>
<?php $__env->startSection('page-title', 'Tambah Media Warga'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card card-primary card-outline">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?php echo e(route('media_warga.index')); ?>" class="btn btn-sm btn-secondary">
    ...
    <?php $__env->startPush('js'); ?>
        <script>
            ...
            const targetUrl = "<?php echo e(route('media_warga.store')); ?>";
            const KkId = "<?php echo e($kk->id ?? ''); ?>"; // pastikan variabel ini ada
            ...
            myDropzone.on("queuecomplete", function() {
                ...
                setTimeout(() => {
                    ...
                    window.location.href = "<?php echo e(route('media_warga.index')); ?>";
                }, 500);
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/ServBay/www/sirega/systems/resources/views/media_warga/create.blade.php ENDPATH**/ ?>