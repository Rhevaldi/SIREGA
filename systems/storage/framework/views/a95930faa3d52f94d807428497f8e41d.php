    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
                <div class="inner text-white">
                    <h3><?php echo e($totalLakiLaki); ?></h3>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
                <div class="inner">
                    <h3><?php echo e($totalPerempuan); ?></h3>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ===============================
            const bansosStatsRaw = <?php echo json_encode($bansosStats, 15, 512) ?>;
            ...
            // ===============================
            const genusLabels = <?php echo json_encode($wargaByJenisKelamin->keys(), 15, 512) ?>;
            const genusData = <?php echo json_encode($wargaByJenisKelamin->values(), 15, 512) ?>;
